...
测静止站立和行走时的头动（/baseline下的baseline.py）,时间1分钟
分三种情况：[1] RB drive HMD [2] RB drive Screen [3] RB with Screen
1. 戴头盔站立，RB（刚体）贴头盔上，RB驱动头盔屏幕，测头动
2. RB贴头上，看屏幕，RB驱动大屏幕，测头动
3. RB贴头上，看屏幕，大屏幕固定（RB不驱动任何屏幕），测头动
【第2种情况pitch方向不自然】
切换condition时在tracking tools中重置RB方向
